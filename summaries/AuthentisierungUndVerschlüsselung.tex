...
\textbf{Motivation}: Wir wollen Signaturen der Form, dass $A$ die Signatur von $B$ verifizieren kann, jedoch einen anderen $C$ nicht davon überzeugen kann, dass die Signatur von $B$ kam.
...
\begin{itemize}
  ...
  \item{$TrapColl_{ch}(\tau, m, r, m')$ für $(m, r, m') \in \mathcal{M} \times \mathcal{R} \rightarrow \mathcal{M}$ berechnet $r' \in \mathcal{R}$, sodass \begin{flalign*}
                ch(m,r) = ch(m', r')
              \end{flalign*}
        }
\end{itemize}
