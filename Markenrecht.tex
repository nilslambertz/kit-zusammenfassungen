...
\textbf{Alle Angaben ohne Gewähr. Keine Garantie auf Vollständigkeit oder Richtigkeit.}
\vspace{-1cm}
...
Nachdem alle erforderlichen Schritte unternommen wurden und der Antrag beim DPMA eingegangen ist, ist man in der Position der \textbf{Anwartschaft}. Dies bedeutet, dass alles nötige unternommen wurde und man sich in einer \textit{rechtlich gesicherten Position} befindet.

\subsection{Anmeldeverfahren §§ 32 ff. MarkenG}\label{sec:Anmeldeverfahren}
...
Zu jeder Anmeldung muss ein \hyperref[sec:Produktbezug]{\textbf{Waren- und Dienstleisungsverzeichnis}} beigefügt werden. Dabei kann die \highlight{Klassifikation von Nizza} verwendet werden, die 34 Waren- und 11 Dienstleistungsklassen unterscheidet. Es können allerdings auch detaillierte Produkte spezifiziert werden.
...
\begin{itemize}
  ...
  \item{der Benutzungsnachweis (5-Jahres-Frist) muss für einen Großteil der Produkte des Oberbegriffs geliefert werden}
  \item{bei Anmeldung ausländischer Marken (innerhalb von 6 Monaten) kann nach der \hyperref[sec:PariserUebereinkunft]{\textbf{Pariser Übereinkunft}} der Prioritätstag gemäß \markenG{34} auf den Tag der Anmeldung im Ausland gesetzt werden. Analog verhält sich \markenG{35}}
\end{itemize}
...
\begin{enumerate}
  ...
  \item{\highlight{Einreden} des Beklagten (\markenGG[20-25]{20})
              \begin{enumerate}
