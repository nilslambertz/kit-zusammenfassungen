...
\begin{table}[h]
  \begin{tabular}{|p{0.5\linewidth}|p{0.5\linewidth}|}
    \hline \rowcolor{gray!30}
    Unionsmarkenverordnung & Äquivalent im MarkenG \\ \hline
    Art. 4                 & § 3                   \\ \hline
    Art. 6                 & § 4                   \\ \hline
    Art. 7                 & § 8                   \\ \hline
    Art. 8                 & § 9                   \\ \hline
  ...
  \end{tabular}
\end{table}
Beachte \textbf{Art. 7 Abs. 1d und Abs. 2 UMV}. Für \textbf{Art. 18 UMV} genügt die ernsthafte Benutzung in einem Mitgliedsstaat.
